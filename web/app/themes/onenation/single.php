        ...
        <div id="primary" class="content-area">
            <main id="main" class="site-main">
                ...
                while (have_posts()) : the_post();
                    ...
                    $obj = fashion_get_post_link('category', 'post');
                        ...
                        <div class="navigation">
                            <?php if (!empty($prev_link)): ?>
                                <div class="previous-nav">
                                    <div class="nav-content">
                                        ...
                                        <div class="nav-link">
                                            <div class="nav-title"><?php esc_html_e('Previous Post', 'fashion'); ?></div>
                            ...
                            <?php if (!empty($next_link)): ?>
                                <div class="next-nav">
                                    <div class="nav-content">
                                        <div class="nav-link">
                                            <div class="nav-title"><?php esc_html_e('Next Post', 'fashion'); ?></div>
                                            <?php if (!empty($next_title)) echo wp_kses_post($next_link); ?>
                                        </div>
                                        <?php echo wp_kses_post($next_link); ?>
                                        <div class="thumbnail-nav"><i class="fa fa-chevron-right"></i></div>
                                    </div>
                    ...
                    if (is_active_sidebar('sidebar-single-post') || (!class_exists('FashionCore') && is_active_sidebar('sidebar-blog'))) {
                        fashion_fnc_related_post(2);
                    } else {
                        fashion_fnc_related_post(3);
                    }
